...
export default function ChatbotPage() {
  ...
  return (
    <div className="h-[calc(100%-1rem)] min-[800px]:h-[calc(100vh-6rem)] min-[800px]:max-h-[calc(100vh-6rem)] max-[800px]:mb-[-5rem] min-h-0 w-full bg-one flex flex-col overflow-hidden relative isolate max-[800px]:mt-10">
